              ...
              child: Column(
                children: [
                  ...
                  BriefCVField(
                    ...
                    initialTags:
                        user.breifcvExists ? user.briefcv!['job_title'] as List<String> : [],
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  ...
                  BriefCVField(
                    ...
                    initialTags:
                        user.breifcvExists ? user.briefcv!['major_skills'] as List<String> : [],
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  ...
                  BriefCVField(
                    ...
                    initialTags:
                        user.breifcvExists ? user.briefcv!['soft_skills'] as List<String> : [],
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  ...
                  BriefCVField(
                    ...
                    initialTags:
                        user.breifcvExists ? user.briefcv!['intrests'] as List<String> : [],
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  ...
                  BriefCVField(
                    ...
                    separaters: const [','],
                    initialTags:
                        user.breifcvExists ? user.briefcv!['other_skills'] as List<String> : [],
                  ),
                  const SizedBox(
                    height: 30,
                  ),
                  ...
                  BriefCVField(
                    ...
                    initialTags: user.breifcvExists
                        ? user.briefcv!['prefered_locations'] as List<String>
                        : [],
                  ),
                  // Row(
                  //   crossAxisAlignment: CrossAxisAlignment.start,
